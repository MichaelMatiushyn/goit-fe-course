...
console.log('Friends of Briana Decker', getUsersByFriend(users, 'Briana Decker')); // [ 'Sharlene Bush', 'Sheree Anthony' ]
console.log('Friends of Goldie Gentry', getUsersByFriend(users, 'Goldie Gentry')); // [ 'Elma Head', 'Sheree Anthony' ]
...
//  */
// const getAllSkills = arr => arr.reduce(
//   (acc, user) => {
